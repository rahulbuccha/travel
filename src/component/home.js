  ...
  return (
    <div>
      <div
        ...
        <div className="text">
          <p> Book Flights, Hotels, Trains, Buses, Cruise and Holiday Packages
            ...
            holiday packages, sift through cruise packages and finalise your entire trip on just one platform.</p>
        </div>
